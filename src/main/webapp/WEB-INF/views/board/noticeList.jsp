	...
	<section>
		<div class="container">
			<div class="container_body">
						...
						<tr>
							...
							<td class="mw350">
								<select name="category" id="category" style="width:100px">
									<c:choose>
									<c:when test="${pMap.category eq 'bd_cont'}">
										<option value="bd_nm">제목</option>
										<option value="bd_cont" selected="selected">내용</option>
									</c:when>
									<c:otherwise>
										<option value="bd_nm">제목</option>
				...
				<div class="tbar">
					<div class="w50 fl"><i class="axi axi-play-arrow"></i>공지사항 목록 </div>
				...
				<div class="button_area tright">
					<a href="/board/noticeAdd" class="button" style="" >등록</a>
				</div>
			</div>
		</div>
	</section>
