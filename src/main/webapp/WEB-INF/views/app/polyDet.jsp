...
<section>
		...
		<div class="container_body">
			...
			<div class="tbar">
				<c:if test="${gubun eq 'det'}">
					<div class="w100 fl"><i class="axi axi-play-arrow"></i>약관 상세</div>
				</c:if>
				<c:if test="${gubun eq 'new'}">
					<div class="w100 fl"><i class="axi axi-play-arrow"></i>약관 신규</div>
				</c:if>
			</div>
	...
	<form action="/app/polyList" method="post" id="backForm">
