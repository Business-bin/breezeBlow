...
<section>
	<div class="container">
		...
		<form id="pushform" name="pushform" method="post" action="/push/pushDet">
  			<input type="hidden" id="R_PUSH_SQ" name="R_PUSH_SQ" value="" />
		...
		<div class="button_area tright">
			<button class="button" id="newBtn"><i class="axi axi-person-add"></i>신규작성</button>
		</div>
		</div>
	</div>
...
<!-- js 작성 -->
<script src="/resources/js/push/pushList.js"></script>