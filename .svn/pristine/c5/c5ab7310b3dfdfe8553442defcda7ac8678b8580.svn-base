...
<section>
		<div class="container">
			<div class="container_body">
				...
				<div class="tbar">
					<div class="w50 fl"><i class="axi axi-play-arrow"></i>B2B 관리자 상세정보</div>
				</div>
				...
				<input type="hidden" name="btbs_sq" id="btbs_sq" value="${rMap.admin.BTBS_SQ}"/>
				<table class="basictables" id="tbody">
					...
					<tr>
						...
						<td colspan="3">
							<input type="text" name="btb_site_nm" id="btb_site_nm" value="${rMap.admin.BTBS_NM}" style="width:300px" readonly/>
							<button class="button" type="button" id="btn_site_nm">사이트명 검색</button>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="3"><input type="text" name="adm_part" id="adm_part" value="${rMap.admin.ADM_PART}" style="width:300px" maxlength="20"/></td>
					</tr>
					<tr>
						<th class="mw110">직급</th>
						<td colspan="3"><input type="text" name="adm_rank" id="adm_rank" value="${rMap.admin.ADM_RANK}" style="width:300px" maxlength="20"/></td>
					</tr>
					<tr>
					...
					<c:if test="${rMap.admin.STAT eq '02' or rMap.admin.STAT eq '03'}">
					<tr>
				...
				<form action="/btb/btbAdminList" method="post" id="backForm">
				...
				<div class="button_area tcenter">
					...
					<button type="button" class="button" id="btn_stop">이용정지</button>
					<button type="button" class="button" id="btn_use">이용정지 해제</button>
					<button type="button" class="button" id="btn_del">삭제</button>
					<button type="button" class="button" id="goList" >목록</button>
				</div>
				<div class="tbar">
					<div class="w50 fl"><i class="axi axi-play-arrow"></i>B2B 관리자 활동로그</div>
				</div>
			...
			<div id="layerPopup2">
				<table class="basictables">
					<tbody>
						<tr>
							<th>아이디</th>
							<td><input type="text" id="admEmail2" name="admEmail" value="${rMap.admin.ADM_EMAIL}" style="width:300px;" disabled/></td>
						</tr>
						<tr>
							<th>이용정지 사유</th>
							<td><textarea rows="5" cols="20" id="stop_comment" name="stop_comment" placeholder="이용정지 사유를 입력하세요" maxlength="100"></textarea></td>
						</tr>
					</tbody>
				</table>
				<div class="button_area tcenter" id="buttonDiv">
					<button class="button" id="goStop" type="button">이용정지</button>
					<button class="button" id="close2" type="button">취소</button>
				</div>
			</div>
			<div id="dim-layer3"></div>
			<div id="layerPopup3">
					...
					<tbody>
						...
						<tr>
							<td><input type="text" id="btbsNm" name="btbsNm" value="" />
								...
								<button class="button" id="close3" type="button">닫기</button></td>
						</tr>
					</tbody>
				</table>
				<table>
