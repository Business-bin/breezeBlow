	...
	fn_initLoadGrid : function() {
		...
		$("#model_list").jqGrid({
			...
			colModel : [ {
				...
				name : "CP_IMG_NM", index : "CP_IMG_NM", sortable : false, width : 30, align : 'center'
			}, {
	...
	fn_SearchGrid : function() {
		...
		$("#model_list").jqGrid({
					...
					colModel : [ {
						...
						name : "CP_IMG_NM", index : "CP_IMG_NM", sortable : false, width : 30, align : 'center', formatter : imageFormatter
					}, {
						name : "CP_NM", index : "CP_NM", sortable : true, width : 30, align : 'center'
					}, {
						name : "MD_NM", index : "MD_NM", sortable : true, width : 30, align : 'center'
